...
class LicenseViewModel: ObservableObject {
    ...
    // Always start in the licensed state to remove the trial limitation
    ...
    func startTrial() {
        // Trial functionality disabled
    }

    private func loadLicenseState() {
        // Bypass trial and licensing checks
        licenseState = .licensed
    }
    
    var canUseApp: Bool {
        // Always allow the app to be used
        true
    }
    ...
    func removeLicense() {
        ...
        // Keep the app licensed even after removing stored keys
        licenseState = .licensed
        licenseKey = ""
